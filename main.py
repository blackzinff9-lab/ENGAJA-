...
async def gerar_conteudo(req: RequisicaoConteudo):
    ...
    # PASSO 2 — Instruções específicas por plataforma
...
"""
    ...
    # PASSO 3 — Prompt rigoroso com formato exato e adaptações
    prompt_principal = f"""
...
"""
    ...
    # PASSO 4 — Extrair, normalizar e tratar campos
